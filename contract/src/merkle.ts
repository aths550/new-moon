// Off-chain Merkle tree builder matching the on-chain persistentHash logic
// in bboard.compact. Uses persistentHash from @midnight-ntwrk/compact-runtime.
