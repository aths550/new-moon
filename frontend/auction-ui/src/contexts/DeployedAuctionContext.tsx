...
import {
  type DeployedAuctionAPIProvider,
  BrowserDeployedAuctionManager,
} from "./BrowserDeployedAuctionManager.js";
import { type Logger } from "pino";

/**
 * Encapsulates a deployed auctions provider as a context object.
 */
export const DeployedAuctionContext = createContext<
  DeployedAuctionAPIProvider | undefined
>(undefined);
 ...
 */
export const DeployedAuctionProvider: React.FC<
  Readonly<DeployedAuctionProviderProps>
> = ({ logger, children }) => (
