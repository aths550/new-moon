...
async function main() {
  ...
  console.log('Waiting 30 seconds for wallet indexer to sync faucet block...');
  ...
  const providers = {
    privateStateProvider: levelPrivateStateProvider({
      privateStateStoreName: 'preview-auction-store-v2',
      signingKeyStoreName: 'preview-auction-signing-keys-v2',
